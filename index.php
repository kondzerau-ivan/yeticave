            ...
            <section class="promo">
                ...
                <ul class="promo__list">
                    <?php foreach ($categories as $key => $category) : ?>
                        <li class="promo__item promo__item--<?= htmlspecialchars($key, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?>">
                            <a class="promo__link" href="pages/<?= htmlspecialchars($key, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?>-lots.html"><?= htmlspecialchars($category, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?></a>
                        </li>
                    <?php endforeach; ?>
                </ul>
            </section>
                    ...
                    <?php foreach ($lots as $lot) : ?>
                        <li class="lots__item lot">
                            <div class="lot__image">
                                <img src="<?= htmlspecialchars($lot['image'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?>" width="350" height="260" alt="<?= htmlspecialchars($lot['name'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?>">
                            </div>
                            <div class="lot__info">
                                <span class="lot__category"><?= htmlspecialchars($lot['category'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?></span>
                                <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?= htmlspecialchars($lot['name'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?></a></h3>
                                <div class="lot__state">
                                    <div class="lot__rate">
                                        <span class="lot__amount">Стартовая цена</span>
                                        <span class="lot__cost"><?= htmlspecialchars(formatPrice($lot['price']), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?></span>
                                    </div>
